...
- The current Plan Mode slice is runtime/protocol first: backend state, transcript events, and desktop store plumbing exist, but the full plan review UI and execution-mode constraints are not productized yet.
